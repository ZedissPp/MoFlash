...
if [[ ! "$(command -v "termux-setup-storage")" ]]; then
	printf "Erro!"
	printf "Execute este script no Termux para continuar."
	exit 1
fi

printf -en "\033[0;32m"
printf "Instalando o MoFlash..."
printf ""
printf "Atualizando espelhos de pacotes..."
pkg update -y && pkg upgrade -y
printf "Instalando & configurando dependências..."
pkg install android-tools wget unzip gawk openssl-tool termux-api -y
cat <<EOF > /data/data/com.termux/files/usr/bin/MoFlash.bash
	#!/data/data/com.temux/files/usr/bin/bash
...
ln -s /data/data/com.termux/files/usr/bin/MoFlash.bash /data/data/com.termux/files/usr/bin/MoFlash

echo "MoFLash instalado com sucesso!"
exit 0
